...
const laws = {
    en: {
        ...
        criminalLaws: [
            ...
            {title:"<h2>The Explosive Substances Act, 1908</h2>",content:"Regulates the manufacture, possession, and use of explosive substances.<ul><b>Regulation:</b> Provides for the regulation of explosives and penalties for unlawful possession and use.<br><b>Licensing:</b> Establishes licensing requirements for handling explosives.</ul>"},
